...
)}\hypertarget{classPassagier_a1a2bc82f5780448cd2a9a47d08cc824f}{}\label{classPassagier_a1a2bc82f5780448cd2a9a47d08cc824f}


Passenger Default Constructor. 

\begin{DoxyPostcond}{Postcondition}
A new Passenger Object has been created 
\end{DoxyPostcond}
...
The Passenger Object has been properly initialized 

The Passenger Object has a non-\/empty member variable begin\+Station 
\end{DoxyPrecond}
...
The Passenger Object has a non-\/empty member variable eind\+Station 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
string 
\end{DoxyReturn}
...
The Passenger Object has a non-\/empty member variable hoeveelheid 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
integer 
\end{DoxyReturn}
...
The Passenger Object has a non-\/empty member variable naam 
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
string 
\end{DoxyReturn}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
The Passenger Object\textquotesingle{}s Starting \hyperlink{classStation}{Station} is equal to variable begin\+Station 
\end{DoxyPostcond}
...
eind\+Station is a non-\/empty string 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
The Passenger Object\textquotesingle{}s End \hyperlink{classStation}{Station} is equal to variable eind\+Station 
\end{DoxyPostcond}
...
hoeveelheid is a positive integer 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
The Passenger Object\textquotesingle{}s Amount is equal to variable hoeveelheid 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
The Passenger Object\textquotesingle{}s Name is equal to variable naam 
\end{DoxyPostcond}
